...
#include"Mesh.h"
#include"Shader.h"
#include"Sphere.h" //Solo tiene para esfera
#include"Window.h"
#include"Camera.h" //luckAt se manda al shader por uniform 
...
int main()
{
	...
	CrearCono(6, 2.0f);//índice 3 en MeshList el 25 es la resolucion si mas grande es el numero se ve mas como circulo, el 2 es el radio 
	...
	*/
	...
	camera = Camera(glm::vec3(0.0f, 2.0f, 6.0f), glm::vec3(0.0f, 1.0f, 0.0f), -90.0f, 1.0f, 0.3f, 0.3f); 
							//posicion                up direccion de y positivo  -60 es velocidad de movimiento y giro
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.78f, 0.68f, 0.88f);
		...
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 0.10f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); 
		meshList[0]->RenderMesh();
		...
		//CVerdeIzquierda
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-1.0f, 3.5f, -2.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 0.10f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); 
		...
		//VCircular Azul
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, -5.5f));
		...
		//CVerdeLateralD
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(2.0f, 3.5f, -3.0f));
		...
		//CVerdeLateralDA
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(2.0f, 3.5f, -5.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 0.10f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		...
		//CCafe Izquierda
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(3.5f, 0.7f, -4.0f));
		...
		//PVerdeArbolI
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(3.5f, 2.8f, -4.0f));
		model = glm::scale(model, glm::vec3(1.4f, 2.8f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
