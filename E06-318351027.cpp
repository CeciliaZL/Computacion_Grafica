...
Texture dadoAnimeles;
Texture cuboAnimales2;
...
// average normals
	GLfloat cubo_vertices[] = {
		...
		// bottom
		//x		y		z		S		T
		-0.5f, -0.5f,  0.5f,	0.50f,  0.01f,		0.0f,	1.0f,	0.0f,	
		0.5f, -0.5f,   0.5f,	0.50f,  0.32f,		0.0f,	1.0f,	0.0f,	
...
int main()
{
	...
	cuboAnimales2 = Texture("Textures/cuboAnimales2.png");
	cuboAnimales2.LoadTextureA();
