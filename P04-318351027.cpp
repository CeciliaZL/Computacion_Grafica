...
int main()
{
	...
	*/
	...
	glm::vec3 colorArticulacion = glm::vec3(0.0f, 0.0f, 0.0f);
	glm::vec3 colorOjos = glm::vec3(0.0f, 0.0f, 0.0f);
	glm::vec3 colorGris = glm::vec3(0.0f, 0.0f, 0.0f);
	glm::vec3 colorNariz = glm::vec3(0.0f, 0.0f, 0.0f);
	glm::vec3 colorBigotes = glm::vec3(0.0f, 0.0f, 0.0f); 
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Piramide
		/*model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.5f, -6.0f, -10.0f));
		model = glm::scale(model, glm::vec3(5.0f, 2.0f, 5.0f));
		color = glm::vec3(0.819f, 0.427f, 0.0f);
		...
		color = glm::vec3(1.0f, 0.752f, 0.796f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.949f, 0.6f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();

		//Llanta 1 Derecha Delantera
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-2.0f, -7.0f, -12.5f));
		...
		color = glm::vec3(1.0f, 0.0f, 0.796f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-2.0f, -7.0f, -7.4f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//******************************************** Gato ***************************************
		// Colores
		colorArticulacion = glm::vec3(0.7f, 0.7f, 0.7f);
		colorOjos = glm::vec3(0.53f, 0.81f, 0.98f);
		colorGris = glm::vec3(0.7f, 0.7f, 0.7f);
		colorNariz = glm::vec3(1.0f, 0.7f, 0.7f);
		colorBigotes = glm::vec3(0.3f, 0.3f, 0.3f); 

		//************************************* Cuerpo
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -8.0f));
		modelauxtronco = model;
		modelaux = model;
		model = glm::scale(model, glm::vec3(10.0f, 3.5f, 3.0f));
		...
		model = glm::translate(modelauxtronco, glm::vec3(4.75f, 1.0f, 0.0f)); // A partir del cuerpo
		...
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f)); // curva 
		modelaux = model;
		...
		//************************** Orejas
		// Izquierda 
		model = glm::translate(modelauxcabeza, glm::vec3(0.5f, 3.8f, 1.2f));
		...
		//***************************** Ojos
		model = glm::translate(model, glm::vec3(-0.7f, 2.25f, 0.75f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		...
		model = glm::translate(modelauxcabeza, glm::vec3(-0.8f, 1.05f, 0.15f)); 
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.02f, 0.02f, 1.5f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorBigotes));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMeshGeometry();
		model = modelauxcabeza;

		model = glm::translate(modelauxcabeza, glm::vec3(-0.8f, 1.0f, 0.3f)); 
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.02f, 0.02f, 2.5f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorBigotes));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMeshGeometry();
		model = modelauxcabeza;
		...
		model = glm::translate(modelauxcabeza, glm::vec3(-0.8f, 0.95f, -0.3f)); 
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.02f, 0.02f, 2.5f)); 
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorBigotes));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//**************************** Nariz
		model = glm::translate(modelauxcabeza, glm::vec3(-1.0f, 1.0f, 0.0f)); 
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorNariz));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
